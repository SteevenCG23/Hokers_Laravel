...
<body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
        <div class="container">
            <a class="navbar-brand" href="#page-top"><img src="{{ asset('images/Logo_Hokers.png') }}" alt="..." /></a>
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
                    <li class="nav-item"><a class="nav-link" href="#hokers">Hokers</a></li>
                    ...
                    @if (Route::has('login'))
                            @auth
                                <li class="nav-item"><a href="{{ url('/home') }}" class="nav-link">Regresar</a></li>
                            @else
    ...
    <!-- Masthead-->
    <header class="masthead" id="hokers">
        <div class="container">
            <div class="masthead-subheading"></div>
            <div class="masthead-heading text-uppercase">HOKERS</div>
            <a class="btn btn-primary btn-xl text-uppercase" href="{{ route('register') }}">REGISTRARME</a>
        </div>
    </header>
    <!-- Services-->
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">Ten una buena experiencia al momento realizar una compra deseada.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Si llegas a presentar un tipo de problema, no dudes en hacérnoslo saber.</p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fas fa-circle fa-stack-2x text-primary"></i>
                    ...
                    <p class="text-muted">Tu información quedará en un lugar seguro, Hokers.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="page-section bg-light" id="equipo">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="team-member">
                        <img class="mx-auto rounded-circle" src="{{ asset('images/usuario.png') }}" alt="..." />
                        <h4>Usuario</h4>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="row">
                <div class="col-lg-8 mx-auto text-center">Vive una experiencia fascinante con cada una una de las
                    persona que se conectan, Hokers.<p class="large text-muted"></p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="page-section" id="contact">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Recuerda que cada sugerencia, es un aporte para mejorar tu
                    experiencia.</h3>
            </div>
            <!-- * * * * * * * * * * * * * * *-->
            ...
            <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group mb-md-0">
                            ...
                            <input class="form-control" id="phone" type="tel"
                                placeholder="Numero telefonico" data-sb-validations="required" />
                ...
                <div class="text-center"><button class="btn btn-primary btn-xl text-uppercase disabled"
                        id="submitButton" type="submit">Enviar sugerencia</button></div>
            </form>
        </div>
    </section>
    <!-- Footer-->
