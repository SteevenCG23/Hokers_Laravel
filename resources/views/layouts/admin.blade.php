        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ url('/admin') }}" class="nav-link">Panel de control administrador</a>
                </li>
            </ul>
      ...
      <li class="nav-item dropdown">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('/admin') }}" class="brand-link">
                <img src="{{ asset('images/Logo_Hokers.png') }}" alt="AdminLTE Logo"
                    class="brand-image img-circle elevation-3" style="opacity: .8">
                <span class="brand-text font-weight-light">Hokers</span>
            </a>
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/users/usersReports') }}" class="nav-link">
                                        <i class="nav-icon fas bi bi-file-earmark-arrow-down-fill"></i>
                                        <p>Reportes</p>
                                    </a>
                                </li>
                            </ul>
                          ...
                          <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/sellers/createSeller') }}" class="nav-link">
                                        <i class="nav-icon fas bi bi-person-plus-fill"></i>
                                        <p>Crear vendedor</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/sellers/sellersIndex') }}" class="nav-link">
                                        <i class="nav-icon fas bi bi-card-list"></i>
                                        <p>Listado de vendedores</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="{{ url('admin/users/sellersReports') }}" class="nav-link">
                                        <i class="nav-icon fas bi bi-file-earmark-arrow-down-fill"></i>
                                        <p>Reportes</p>
                                    </a>
                                </li>
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{ url('admin/products/create') }}" class="nav-link">
                                        <i class="nav-icon fas bi bi-cart-plus-fill"></i>
                                        <p>Crear producto</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/users/reports') }}" class="nav-link">
                                        <i class="nav-icon fas bi bi-file-earmark-arrow-down-fill"></i>
                                        <p>Reportes</p>
                                    </a>
                                </li>
